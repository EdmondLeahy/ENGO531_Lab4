...
double ransac_confidence = 99;
double outlier_percentage = 0.6;
int min_iterations = 20;
double dThreshold = 1 * pow(10,-7);
...
int main() {
	...
	intersection(xy_01_0, xy_01_1, RO1, RO2, camera_params, "Intersection_01.txt");


	//Intersection img 1-3
	intersection(xy_02_0, xy_02_2, RO1, RO3, camera_params, "Intersection_02.txt");


	//Intersection img 2-3
	intersection(xy_12_1, xy_12_2, RO2, RO3, camera_params, "Intersection_12.txt");
